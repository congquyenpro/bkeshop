...
class StatisticWarehouseController extends Controller
{
    protected $warehouse;
    ...
    public function index(){
        $InventoryInfor = $this->warehouse->getInventory();
        return view('admin.manager.ware',[
            'InventoryInfor' => $InventoryInfor,
        ]);
    }
